 ...
 * @date 2018/4/17
 */
public class GenerateService2 {

//    private static final String MALE_PREFIX = "QM";
...
//
//            File file = new File("/Users/xin/Desktop/qm.txt");
//            if(file.exists()) {
//            	file.delete();
//            }
...
//        List<List<Object>> list = ExcelUtil.readRowsAutoDetectEndCol(inputStream, true, 0, 1, 10, 14);
...
//        		String questionId = MALE_PREFIX + formatStr + "0" + (modNum%4);
...
//            spdAnswer.setAnswer_content((String) record.get(2));
//            String score1 = (String) record.get(6);
...
//            String score2 = (String) record.get(7);
...
//            spdAnswer.setAnswer_content((String) record.get(4));
//            String score3 = (String) record.get(8);
...
//            String score4 = (String) record.get(9);
