...
public class SearchBrand {
	...
	private String brand_short_name = "";
	...
	public String getBrand_short_name() {
		return brand_short_name;
	}

	public void setBrand_short_name(String brand_short_name) {
		this.brand_short_name = brand_short_name;
	}
